...
def compute_purity(labels, clusters, num_clusters, logger):
    """
    ...
    for idx in range(num_clusters):
        logger.info("Cluster {} matched to label {}. Its purity is {:.4f}".format(idx,
                                                                                  matched_labels[idx],
                                                                                  purity_list[idx]))
    logger.info("Average purity is {:.4f}".format(np.mean(purity_list)))
